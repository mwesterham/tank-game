class EnemyTank
{
  ...
  public void shoot()
  {
    myController.addBullet(new Bullet(bullet_size, bullet_speed, getPosition()[0], getPosition()[1], getDirection(), getTurretLength(), true, false, true, false, 0, 0, 0, tank_color[0], tank_color[1], tank_color[2]));
